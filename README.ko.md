...
> **0.5.0 준비 중 — 다운로드 보류** (2026-09-20)
>
> 0.5.0 시험 버전의 개발·검증을 진행하고 있습니다. 현재 홈페이지의 다운로드 버튼은
> 비활성 상태이며 0.5.0 설치 파일과 자동 업데이트는 공개하지 않습니다.
> [0.5.0 준비 현황](docs/V050-PREPARATION.md)을 확인해 주세요.
> 아래 0.4.2 문서는 기존 공개 버전의 기록이며 0.5.0 출시 완료를 뜻하지 않습니다.
