...
Version `0.4.0` is the first **Free Early Access** release. It contains no account, advertising,
...
Use a version-pinned release under this repository or the official PCSSAK download page only after
the public-release gate has opened:

- GitHub release: `https://github.com/pcssakinc/pcssak-arodama-releases/releases/tag/v0.4.0`
...
A download is official only when `v0.4.0` is a published, non-draft, non-prerelease GitHub Latest
release with the exact 17 assets below and independent anonymous re-download verification has
passed. Repository files, pull-request artifacts, branch previews, source tags, work logs, and
...
The v0.4.0 installers are **not signed with Windows Authenticode**. Windows can show Unknown
...
not available in v0.4.0. Permanent deletion remains available. This store is separate from the
Windows Recycle Bin.
...
- Security reports: follow [SECURITY.md](SECURITY.md) and use GitHub Private Vulnerability Reporting.
