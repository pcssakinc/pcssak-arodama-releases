...
This guide applies to PCssak AroDamA Free Early Access `0.4.0`.

## 1. Use an official release

Install only after `v0.4.0` appears as a public, non-draft, non-prerelease GitHub Latest release
with the exact 17 assets documented in [RELEASE-ASSET-POLICY.md](RELEASE-ASSET-POLICY.md).
...
| --- | --- | --- |
| Windows 11 Home/Pro x64 | `PCSSAK-AroDamA-Free-Early-Access-v0.4.0-Windows-x64-Setup.exe` | Primary support candidate |
| Windows 10 22H2 Home/Pro x64 | x64 installer | Limited compatibility candidate |
| Windows 10 22H2 Home/Pro x86 | `PCSSAK-AroDamA-Free-Early-Access-v0.4.0-Windows-x86-Setup.exe` | Limited compatibility candidate |
...
The `0.4.0` installers are **not Windows Authenticode-signed**. Windows may show Unknown Publisher,
...
The installer language and the in-app language are separate choices. The application supports
Korean, English, German, Spanish, Portuguese (Brazil), Japanese, French, and Simplified Chinese.
